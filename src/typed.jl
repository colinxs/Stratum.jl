...
function send(x::StratumEndpoint, request::RequestType{TPARAM,TR}, params::TPARAM) where {TPARAM,TR}
...
function send(x::StratumEndpoint, notification::NotificationType{TPARAM}, params::TPARAM) where TPARAM
...
function dispatch_msg(x::StratumEndpoint, dispatcher::MsgDispatcher, msg)
